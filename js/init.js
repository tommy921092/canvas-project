...
$(document).ready(function() {
  ...
  $("#lineDash").on("input", function() {
    contextDraft.setLineDash([$(this).val(), $(this).val()]);
    contextReal.setLineDash([$(this).val(), $(this).val()]);
  });
  ...
  $("#pencilType").on("input", function() {
    if ($(this).val() == "Solid") {
      ...
      contextReal.shadowColor = "";
      contextDraft.setLineDash([]);
      contextDraft.shadowBlur = 0;
      contextDraft.shadowColor = "";
    } else if ($(this).val() == "Dotted") {
      contextReal.setLineDash([10, 10]);
      contextReal.shadowBlur = 0;
      contextReal.shadowColor = "";
      contextDraft.setLineDash([10, 10]);
      contextDraft.shadowBlur = 0;
      contextDraft.shadowColor = "";
    } else if ($(this).val() == "Shadow") {
      contextReal.setLineDash([]);
      contextReal.shadowBlur = 10;
      contextReal.shadowColor = "rgb(0, 0, 0)";
      contextDraft.setLineDash([]);
  ...
  //for pen
  $(
    "#tools button:nth-child(2),#tools button:nth-child(3),#tools button:nth-child(4)"
  ).on("click", function(e) {
  ...
  $("#tools button:nth-child(6)").on("click", function(e) {
    ...
    $(this).toggleClass("active");
    $(
      ".styleAttr li:nth-child(5),.styleAttr li:nth-child(6),.styleAttr li:nth-child(7),.styleAttr li:nth-child(8),.styleAttr li:nth-child(9)"
    ).css("display", "none");
  ...
  $(".dropdown-menu button").on("click", function(e) {
    $(".dropdown .dropdown-toggle i").attr(
      "class",
      $(this)
        .children()
        .attr("class")
